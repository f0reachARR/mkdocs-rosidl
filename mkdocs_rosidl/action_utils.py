...
"""Action utilities for ROS2 interface documentation generation."""

import pathlib

from ament_index_python.packages import get_package_share_directory
from mkdocs_rosidl import utils
from rosidl_parser.definition import Action, IdlLocator
from rosidl_parser.parser import parse_idl_file


def generate_msg_text_from_spec(package, interface_name, indent=0):
    """
    Generate a dictionary with the compact action.

    :param package: name of the package
    :type package: str
    :param interface_name: name of the action
    ...
    for attribute in ['goal', 'result', 'feedback']:
        ...
        utils.copy_dict_with_suffix(compact_action, definition, attribute)
